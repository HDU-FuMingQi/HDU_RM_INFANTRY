...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, IST_RESET_Pin|LED2_Pin|GPIO_PIN_14, GPIO_PIN_SET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(POWER5_GPIO_Port, POWER5_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : PEPin PE14 */
  GPIO_InitStruct.Pin = IST_RESET_Pin|GPIO_PIN_14;
  ...
  /*Configure GPIO pin : PtPin */
  GPIO_InitStruct.Pin = key_signal_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(key_signal_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : PtPin */
  GPIO_InitStruct.Pin = POWER5_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(POWER5_GPIO_Port, &GPIO_InitStruct);
