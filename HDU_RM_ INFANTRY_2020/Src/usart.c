...
/* USER CODE BEGIN 1 */
/////////////////////////////////////串口3 DMA接受裁判系统发来的信息，可以读到所有裁判系统发来的消息//////////////////////////////////////
...
//			HAL_DMA_Start_IT (&hdma_usart3_rx,(uint32_t)Judge_Buffer, (uint32_t)&(USART3->DR), 200);
			HAL_UART_Receive_DMA(&huart3,Judge_Buffer,200);//重新打开DMA接收
		}
